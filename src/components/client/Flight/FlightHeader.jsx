        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between text-white">
          ...
          <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:items-center sm:gap-3">
            ...
            <button
              type="button"
              onClick={onOpen}
              className="inline-flex md:hidden text-black items-center justify-center gap-2 rounded-xl bg-white px-3 py-2 text-sm font-medium text-slate-800 shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white/40"
