      ...
      <div className="divide-y divide-slate-200">
        ...
        <section className="bg-white">
          ...
          <div
            id={outId}
            className={`${
              openSections.fare ? "block" : "hidden"
            } px-4 py-3`}
          >
            ...
            <p className="mt-2 text-sm text-muted py-3">
              Please note that the fare rules provided at time of booking will be
              manually verified if you wish to change and/or cancel at the time
              of your request and you will be quoted accordingly.
            </p>
          </div>
        </section>
      </div>
